...
def generate_pin():
    """Generates a unique 6-digit PIN for USSD and Voice access."""
...
class Space(models.Model):
    ...
    is_public = models.BooleanField(
        default=True, help_text="Public spaces are visible in USSD browse"
    )
...
class ActiveSpaceParticipant(models.Model):
    ...
    space = models.ForeignKey(
        Space, related_name="active_participants", on_delete=models.CASCADE
    )
    phone_number = models.CharField(max_length=20)
